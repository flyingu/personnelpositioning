...
unsigned char   powerValue=15;
unsigned char   Sx1278_snr=0;
unsigned char   Sx1278_LatestRSSI=0;
unsigned char   Sx1278_CurrentRSSI=0;

unsigned char   power_data[16]={0X80,0X81,0X81,0X83,0X84,0X85,0X86,0X87,0X88,0X89,0x8a,0x8b,0x8c,0x8d,0x8e,0x8f};
...
{
  SX1276LoRaSetOpMode(Stdby_mode );
  //SX1278LoRaSetRFFrequency(471500000);
