...
flash_store_data_t flash_store_data_default={ 
  .flash_store_data_s.flashdataempty=0xa1,
  .flash_store_data_s.gpslooptime.i32=20, 
  .flash_store_data_s.worktime.i32=30600,
  .flash_store_data_s.resttime.i32=63000, 
  .flash_store_data_s.fre={0x75,0xe0,0x00},
  .flash_store_data_s.sf=12,
  .flash_store_data_s.cr=2, 
  .flash_store_data_s.bw=2,
  .flash_store_data_s.power=7,
};
