...
flash_store_data_t flash_store_data_default={ 
  .flash_store_data_s.flashdataempty=0xa3,//1
  .flash_store_data_s.gpslooptime.i32=0x0000003c, //4
...
void flashdata_load(void){
  ...
  if(flash_store_data.flash_store_data_s.flashdataempty!=0xa3){
  // myflash_write(data,4);
  // myflash_read(flash_data,4);
