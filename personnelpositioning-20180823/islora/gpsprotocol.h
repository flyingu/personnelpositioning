...
typedef enum 
{
   PROTOCOL_TYPE_SOS	        = (unsigned char)0x19,
   PROTOCOL_TYPE_GPS	        = (unsigned char)0x19,
   PROTOCOL_TYPE_CFGGPSTIME	= (unsigned char)0x80,
   PROTOCOL_TYPE_GPS_FAIL	= (unsigned char)0x22,
   PROTOCOL_TYPE_GPS_RESPONSE   = (unsigned char)0x3f,
